...
/***/ "./node_modules/raw-loader/dist/cjs.js!./src/app/actions/actions.component.html":
/*!**************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/actions/actions.component.html ***!
  \**************************************************************************************/
...
/* harmony default export */ __webpack_exports__["default"] = ("<body>\n    <a [routerLink]=\"['/new']\">create a new poll</a><a (click)=\"logout()\">LogOut</a>\n    <h3>Current Polls</h3>\n    <form (submit)=\"search()\">\n        <input type=\"text\" name=\"val\" [(ngModel)]=\"searched\" />\n        <input type=\"submit\" value=\"search\">\n    </form>\n    <table>\n        <tr>\n            <th>Name</th>\n            <th>Question</th>\n            <th>Date Posted</th>\n            <th>Actions</th>\n        </tr>\n        <tr *ngFor=\"let question of questions\">\n            <td>{{ question.name }}</td>\n            <td><a [routerLink]=\"['/edit/', question._id]\">{{ question.question }}</a></td>\n            <td>{{ question.updated_at }}</td>\n            <td>\n                <button *ngIf=\" question.name == user\" (click)=\"deleteQuestion(question._id)\">Delete</button>\n            </td>\n        </tr>\n    </table>\n    <br>\n            <br>\n            <h3>Your search results</h3>\n    <table *ngIf=\"searchres\">\n            <tr>\n                <th>Name</th>\n                <th>Question</th>\n                <th>Date Posted</th>\n                <th>Actions</th>\n            </tr>\n            <tr *ngFor=\"let question of searchres\">\n                <td>{{ question.name }}</td>\n                <td><a [routerLink]=\"['/edit/', question._id]\">{{ question.question }}</a></td>\n                <td>{{ question.updated_at }}</td>\n                <td>\n                    <button *ngIf=\" question.name == user\" (click)=\"deleteQuestion(question._id)\">Delete</button>\n                </td>\n            </tr>\n        </table>\n</body>");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<body>\n        <a [routerLink]=\"['/actions']\">Go to polls</a>\n        <h3>{{question.question}}</h3>\n        <table>\n            <tr>\n                <th>Option</th>\n                <th>CurrentCount of votes</th>\n                <th>ACtion</th>\n            </tr>\n            <tr >\n                <td>{{ question.option1 }}</td>\n                <td>{{ question.vote1}}</td>\n                <td><button (click)=\"addvote1(question._id)\">Vote</button></td>\n            </tr>\n            <tr >\n                <td>{{ question.option2 }}</td>\n                <td>{{ question.vote2}}</td>\n                <td><button (click)=\"addvote2(question._id)\">Vote</button></td>\n            </tr>\n            <tr >\n                <td>{{ question.option3 }}</td>\n                <td>{{ question.vote3}}</td>\n                <td><button (click)=\"addvote3(question._id)\">Vote</button></td>\n            </tr>\n            <tr >\n                <td>{{ question.option4 }}</td>\n                <td>{{ question.vote4}}</td>\n                <td><button (click)=\"addvote4(question._id)\">Vote</button></td>\n            </tr>\n        </table>\n    </body>");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<body>\n\n        <form (submit)=\"login()\" method =\"POST\">\n            <p>Name:<input type=\"text\" name=\"user\" [(ngModel)]=\"user\"></p>\n            <button type=\"submit\">Register</button>\n        </form> \n</body>\n\n");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<h3>Add a new Poll</h3>\n<h4><a [routerLink]=\"['/actions']\">Back to Polls</a></h4>\n<form (submit)=\"addQuestion()\" method=\"post\">\n    <p *ngIf=\"errors != null\"> <span *ngIf=\"errors.question\">{{ errors.question.message }}</span></p>\n    <p>Question:<input type=\"text\" name=\"newquestion.question\" [(ngModel)]=\"newquestion.question\" /></p>\n    <p *ngIf=\"errors != null\"> <span *ngIf=\"errors.option1\">{{ errors.option1.message }}</span></p>\n    <p>Option 1:<input type=\"text\" name=\"newquestion.option1\" [(ngModel)]=\"newquestion.option1\" /></p>\n    <p *ngIf=\"errors != null\"> <span *ngIf=\"errors.option2\">{{ errors.option2.message }}</span></p>\n    <p>Option 2:<input type=\"text\" name=\"newquestion.option2\" [(ngModel)]=\"newquestion.option2\" /></p>\n    <p *ngIf=\"errors != null\"> <span *ngIf=\"errors.option3\">{{ errors.option3.message }}</span></p>\n    <p>Option 3:<input type=\"text\" name=\"newquestion.option3\" [(ngModel)]=\"newquestion.option3\" /></p>\n    <p *ngIf=\"errors != null\"> <span *ngIf=\"errors.option4\">{{ errors.option4.message }}</span></p>\n    <p>Option 4:<input type=\"text\" name=\"newquestion.option4\" [(ngModel)]=\"newquestion.option4\" /></p>\n    <input type=\"submit\" value=\"Create Poll\">\n</form>");
...
ActionsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./actions.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/actions/actions.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./actions.component.css */ "./src/app/actions/actions.component.css")).default]
    })
], ActionsComponent);
...
/* harmony import */ var _actions_actions_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./actions/actions.component */ "./src/app/actions/actions.component.ts");
...
const routes = [
    ...
    { path: 'actions', component: _actions_actions_component__WEBPACK_IMPORTED_MODULE_3__["ActionsComponent"] },
...
/* harmony import */ var _actions_actions_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./actions/actions.component */ "./src/app/actions/actions.component.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _actions_actions_component__WEBPACK_IMPORTED_MODULE_8__["ActionsComponent"],
...
module.exports = __webpack_require__(/*! C:\Users\colt4\Desktop\MEAN _stack\Angular\Authors\public\src\main.ts */"./src/main.ts");
